class Program10a_
{
    ...
    // cr_mn: ten "postion(Start)" idealnie mozna reprezentowac pomoca krotki (parki) zamiast tablicy
    //static int[] positionStart = { 0, 0 }; 
    static (int x, int y) positionStart = (0, 0);
