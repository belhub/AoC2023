...
class Program5b_
{
    ...
    // cr_mn: tutaj dla lini tworzony jest slownik gdzie kluczem jest numer kolejnej "mapy"
    // gdy kluczem w "mapie" jest kolejny indeks to lepiej/wydajniej jest wykorzystac Array lub List
